...
// kubectl global options that appear before the subcommand: --context, --namespace,
// -n, --kubeconfig, -s, --server, --cluster, --user, --as (fork addition).
static KUBECTL_GLOBAL_OPT: LazyLock<Regex> = LazyLock::new(|| {
...
mod tests {
    ...
    fn test_routable_wrapper_honours_exclude_commands() {
        ...
        assert_eq!(
            ...
            Some("uv run rtk read --line-range 1:20 src/main.rs".into())
        );
    }
